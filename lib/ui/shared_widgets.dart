...
class HowzyLogo extends StatelessWidget {
  const HowzyLogo({super.key, this.tagline = false, this.large = false, this.dark = false});
...
/// Paints the Howzy house-mark SVG: gradient-stroked house outline + 4 window squares.
/// Matches the React Logo.tsx SVG exactly (viewBox 0 0 100 100).
class _HowzyMarkPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // House outline path: M20,70 L20,40 L50,15 L80,40 L80,90
    final path = Path()
      ..moveTo(20 * s, 70 * s)
      ..lineTo(20 * s, 40 * s)
      ..lineTo(50 * s, 15 * s)
